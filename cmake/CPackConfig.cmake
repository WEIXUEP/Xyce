...
elseif (Xyce_NONFREE_MODELS)
  set( Xyce_BaseName "${Xyce_BaseName}NF")
else ()
  set( Xyce_BaseName "${Xyce_BaseName}OpenSource")
endif ()
if( Xyce_PARALLEL_MPI )
  set( Xyce_BaseName "${Xyce_BaseName}_OMPI")
endif ()


set ( Xyce_INSTALL_NAME_wVer "${Xyce_BaseName}_${Xyce_VERSION_STRING_SHORT}" )
set ( Xyce_INSTALL_NAME "${Xyce_BaseName}" )
...
set ( CPACK_PACKAGE_INSTALL_DIRECTORY "${Xyce_INSTALL_NAME_wVer}" )

# generator specific settings

if ( CMAKE_HOST_UNIX )
  # set default install location on unix to /usr/local
  set (CPACK_PACKAGING_INSTALL_PREFIX "/usr/local/${Xyce_INSTALL_NAME_wVer}")
  ...
  set ( CPACK_RPM_PACKAGE_LICENSE "GPLv3" CACHE STRING "The Xyce license")
  set( CPACK_RPM_PACKAGE_RELOCATABLE "true")
  set( CPACK_RPM_PACKAGE_AUTOREQ 0)
  if( Xyce_PARALLEL_MPI )
    set( CPACK_RPM_PACKAGE_REQUIRES "glibc >= 2.28,libcurl.so.4()(64bit),libgomp.so.1(GOMP_4.5)(64bit),libgomp.so.1(OMP_3.0)(64bit),libblas.so.3()(64bit),liblapack.so.3()(64bit),openmpi >= 4" )
  else()
    set( CPACK_RPM_PACKAGE_REQUIRES "glibc >= 2.28,libcurl.so.4()(64bit),libgomp.so.1(GOMP_4.5)(64bit),libgomp.so.1(OMP_3.0)(64bit),libblas.so.3()(64bit),liblapack.so.3()(64bit)" )
  endif()
  set( CPACK_DEBIAN_FILE_NAME "${Xyce_BaseName}-${Xyce_VERSION_STRING_LONG}.deb" )
  ...
  if ( Xyce_VERSION_EXTRA )
    set ( CPACK_RPM_PACKAGE_NAME "${Xyce_BaseName}-${Xyce_VERSION_EXTRA}" )
    set( CPACK_DEBIAN_PACKAGE_NAME "${Xyce_BaseName}-${Xyce_VERSION_EXTRA}")
    set(CPACK_ARCHIVE_FILE_NAME "${Xyce_BaseName}-${Xyce_VERSION_EXTRA}")
  else()
    set ( CPACK_RPM_PACKAGE_NAME "${Xyce_BaseName}" )
    set( CPACK_DEBIAN_PACKAGE_NAME "${Xyce_BaseName}")
    set(CPACK_ARCHIVE_FILE_NAME "${Xyce_BaseName}")
  endif()
